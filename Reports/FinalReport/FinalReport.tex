...
\subsection{Algorithms and Implementations} % 700 words - currently 170
...
as modern vehicles are equipped with cameras and powerful computers, which can run the algorithm in real-time.\\
...
Operating System (ROS), Enki and Gazebo. ROS is a set of soft
