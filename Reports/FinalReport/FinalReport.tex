...
\subsection{Technical Frameworks and Models} % 800 words - currently 580
...
\begin{figure}[h]
    ...
    \end{minipage}
    \caption[Short caption]{Example of Particle Filter in a 2D environment \cite{particle_filter}}
\end{figure}
...
%Another technique used in SLAM is particle filters. Particle filters, also known as Monte Carlo localization, is a probabalistic
%technique used to estimate the localization of a robot in its environment. It starts with a set of particles randomly distributed
