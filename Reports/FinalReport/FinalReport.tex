...
Algorithm. The noise parameter I settles on was 0.0005, shown in the middle plot.\\
...
There were some outliers however, which when investigated were found to be where walls met at a corner; demonstrating the limitations
